    ...
    <UserLayout>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <Link :href="route('user.categories.index')" class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">Danh mục</Link>
                        </div>
                    </li>
            ...
            <div class="mb-8">
                ...
                <p class="text-gray-600 mt-2">{{ category.description || 'Khám phá sản phẩm trong danh mục này' }}</p>
            </div>
...
const applyFilters = () => {
    router.get(route('user.categories.show', props.category.id), filters.value, {
        preserveState: true,
        replace: true
    })
}
